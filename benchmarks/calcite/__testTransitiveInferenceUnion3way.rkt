...
(define (q1 tables) 
  ...
  WHERE (BINOP "emp1.deptno" > 1))) ["t6" (list "deptno")]) (NAMED (RENAME (list-ref tables 4) "emp2"))) 
...
(define (q2 tables) 
  ...
  FROM (NAMED (RENAME (list-ref tables 4) "emp5")) 
  ...
  FROM (NAMED (RENAME (list-ref tables 4) "emp6")) 
