...
(define (q2 tables) 
  ...
  WHERE (AND (BINOP "emp0.deptno" = "dept0.deptno") (BINOP "emp0.ename" = str_foo_))) ["t1" (list "empno" "ename" "job" "mgr" "hiredate" "comm" "sal" "deptno" "slacker" "deptno" "name")]) (AS (NAMED (list-ref tables 3)) ["dept1"])) 
