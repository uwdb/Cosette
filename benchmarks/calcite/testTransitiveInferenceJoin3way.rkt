...
(define (q1 tables) 
  ...
  WHERE (BINOP "emp.deptno" > 7)) ["t" (list "empno" "ename" "job" "mgr" "hiredate" "comm" "sal" "deptno" "slacker")]) (JOIN (AS (NAMED (list-ref tables 4)) ["emp0"]) (AS (NAMED (list-ref tables 4)) ["emp1"]))) 
