...
(define (q1 tables) 
  ...
  WHERE (OR (OR (BINOP "emp.deptno" = 7) (BINOP "emp.deptno" = 9)) (BINOP "emp.deptno" > 10))) ["t" (list "empno" "ename" "job" "mgr" "hiredate" "comm" "sal" "deptno" "slacker")]) (NAMED (RENAME (list-ref tables 4) "emp0"))) 
...
(define (q2 tables) 
  ...
  WHERE (OR (OR (BINOP "emp1.deptno" = 7) (BINOP "emp1.deptno" = 9)) (BINOP "emp1.deptno" > 10))) ["t1" (list "empno" "ename" "job" "mgr" "hiredate" "comm" "sal" "deptno" "slacker")]) (AS (SELECT (VALS "emp2.empno" "emp2.ename" "emp2.job" "emp2.mgr" "emp2.hiredate" "emp2.comm" "emp2.sal" "emp2.deptno" "emp2.slacker") 
  FROM (NAMED (RENAME (list-ref tables 4) "emp2")) 
  WHERE (OR (OR (BINOP "emp2.deptno" = 7) (BINOP "emp2.deptno" = 9)) (BINOP "emp2.deptno" > 10))) ["t2" (list "empno" "ename" "job" "mgr" "hiredate" "comm" "sal" "deptno" "slacker")])) 
