...
(define st3 (Table "CurrentDateTimeDefaultValues" (list "ID" "C") (gen-sym-schema 2 1)))
(define st4 (Table "NewGuidDefaultValues" (list "ID" "C") (gen-sym-schema 2 1)))
