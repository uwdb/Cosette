...
(define (q1 tables) 
  ...
  WHERE (OR (OR (BINOP "emp.deptno" = 7) (BINOP "emp.deptno" = 9)) (BINOP "emp.deptno" > 10))) ["t" (list "empno" "ename" "job" "mgr" "hiredate" "comm" "sal" "deptno" "slacker")]) (AS (NAMED (list-ref tables 4)) ["emp0"])) 
