...
if __name__ == '__main__':
    ...
    run_equiv_check_benchmarks("rosette/cex-benchmarks", ".", "./output/2cex-symbreak", time_limit=60, symbreak=True, simplify=True, qex_enc=False)
    run_equiv_check_benchmarks("rosette/cex-benchmarks", ".", "./output/2cex-nosymbreak", time_limit=60, symbreak=False, simplify=True, qex_enc=False)
    run_equiv_check_benchmarks("rosette/cex-benchmarks", ".", "./output/2cex-symbreak-qex", time_limit=60, symbreak=True, simplify=True, qex_enc=True)
    run_equiv_check_benchmarks("rosette/cex-benchmarks", ".", "./output/2cex-nosymbreak-qex", time_limit=60, symbreak=False, simplify=True, qex_enc=True)
